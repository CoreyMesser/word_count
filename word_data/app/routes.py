...
# from word_data.app import routes_app as app

from word_data.app.forms import LoginForm, RegistrationForm

from word_data.models import User

from werkzeug.urls import url_parse

from word_data.run import app


@app.route('/')
@app.route('/index')
def index():
    return render_template("word_data/app/templates/index.html", title='Home')
...
def user(username):
    ...
    return render_template(url_for('user.html'), user=user, titles=titles)